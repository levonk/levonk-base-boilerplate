...
| Story ID | Story Title | Branch | Dependencies | Parallel-safe | Modules |
| -------- | ----------- | ------ | ------------ | ------------- | ------- |
| 03-001 | Structured Errors & Exit Codes | feature/current/20260708-cli-python-aix/story-03-001-structured-errors | 02-004 | Parallel-safe: true | [errors.py, output.py] | [~] In-Progress |
