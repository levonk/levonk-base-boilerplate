...
- `boilerplate/apps/cli/rust/core/src/internal/prompts/suppressor.rs` — Prompt suppression logic (new file)
- `boilerplate/apps/cli/rust/core/src/internal/prompts/tests.rs` — Tests for prompt suppression (new file)
- `boilerplate/apps/cli/rust/core/src/cli/commands/*.rs` — Update commands with prompts
- `boilerplate/apps/cli/rust/core/src/cli/commands/*_tests.rs` — Update tests for prompt behavior
- `boilerplate/apps/cli/rust/core/src/cli/root.rs` — Add `--force` flag
