...
- [x] Create terminal size detection utility — `core/files/terminal.go.jinja`
- [x] Implement terminal width detection on startup — `core/files/terminal.go.jinja`
- [x] Add resize event handling — `core/files/terminal.go.jinja`
- [x] Implement responsive output formatting — `core/files/terminal.go.jinja`
- [x] Add 80-column default fallback — `core/files/terminal.go.jinja`
- [x] Update output formatting to use terminal width — `core/files/main.go.jinja`
- [x] Test terminal width detection — `core/files/terminal_test.go.jinja`
- [x] Test responsive formatting — `core/files/terminal_test.go.jinja`
- [x] Test fallback to 80 columns — `core/files/terminal_test.go.jinja`
...
- [x] Output formatting responds to terminal width
- [x] Resize events are handled where possible
- [x] Falls back to 80-column default
- [x] Output is readable at all terminal sizes
- [x] Terminal detection doesn't break in non-TTY environments
