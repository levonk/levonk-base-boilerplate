...
- [x] Data export commands produce valid export files
- [x] Offline analysis commands work on exported data
- [x] Collection and processing separated cleanly
- [x] Cross-environment workflow supported
- [x] All tests pass
