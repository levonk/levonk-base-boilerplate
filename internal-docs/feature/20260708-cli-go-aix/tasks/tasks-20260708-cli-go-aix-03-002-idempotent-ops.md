...
- `boilerplate/apps/cli/go/core/files/internal/idempotency/handler.go` — Idempotency logic (new file)
- `boilerplate/apps/cli/go/core/files/internal/idempotency/handler_test.go` — Tests for idempotency (new file)
- `boilerplate/apps/cli/go/core/files/cli/commands/create.go` — Update create operations
- `boilerplate/apps/cli/go/core/files/cli/commands/update.go` — Update update operations
- `boilerplate/apps/cli/go/core/files/cli/commands/delete.go` — Update delete operations
- `boilerplate/apps/cli/go/core/files/cli/commands/close.go` — Update close operations
- `boilerplate/apps/cli/go/core/files/cli/commands/*_test.go` — Update tests for idempotency
